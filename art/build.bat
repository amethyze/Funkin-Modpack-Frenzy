...
:64debug
"C:\HaxeToolkit\haxe\lime.exe" build windows -debug
...
:64release
"C:\HaxeToolkit\haxe\lime.exe" build windows -release
pushd export\release\windows\bin
title DONE
pause
title Running...
...
:32debug
"C:\HaxeToolkit\haxe\lime.exe" build windows -32 -release -D 32bits
...
:htmldebug
"C:\HaxeToolkit\haxe\lime.exe" test html5 -debug
goto start

:htmlrelease
"C:\HaxeToolkit\haxe\lime.exe" test html5 -release
goto start