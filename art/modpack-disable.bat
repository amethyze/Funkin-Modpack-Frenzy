...
if exist week-lullaby.json (echo [21] Friday Night Lullaby)
...
:modchange
echo Are you sure you wish to deactivate this mod? You won't see it anymore in-game. (To enable again, open "Enable-Mods.bat".)
set /p finalchoice=""
