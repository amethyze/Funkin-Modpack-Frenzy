function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'phantom' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'exe/killNOTES/PhantomNote'); --Change texture
			--setPropertyFromGroup('unspawnNotes', i, 'hitHealth', '0.4'); --Default value is: 0.23, health gained on hit
