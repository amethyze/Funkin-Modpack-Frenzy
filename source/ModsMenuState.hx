...
class ModsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		noModsTxt = new FlxText(0, 0, FlxG.width, "IF YOU CAN READ THIS TEXT, PLEASE\nGO BACK AND REOPEN THE MODS MENU. \nIF AFTER DOING THAT, YOU STILL SEE THIS TEXT, YOUR COPY OF MODPACK FRENZY IS BROKEN. \nTHEN YOU MUST REINSTALL MODPACK FRENZY.", 48);
